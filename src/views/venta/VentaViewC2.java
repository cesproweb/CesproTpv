...
public class VentaViewC2 extends BorderPane {
    ...
    public VentaViewC2(VentaController controller) {
    ...
    private void construirUI() {
        ...
        panelCategorias.setAlignment(Pos.CENTER_LEFT);

        Label lblCat = new Label("Categorías:");
        lblCat.setFont(Font.font(18));
